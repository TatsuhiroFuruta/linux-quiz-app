      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <button
            ...
            className="bg-linear-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 p-8 rounded-xl shadow-xl transition transform hover:scale-105"
          >
          ...
          <div className="bg-linear-to-br from-orange-600 to-orange-700 p-8 rounded-xl shadow-xl">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full bg-white/20 hover:bg-white/30 py-3 rounded-lg font-bold transition transform hover:scale-105"
              >
                初心者コース
              </button>
              <button
